...
const Pages = ({ content }) => (
  <React.Fragment>
    <Head>
      <title>Geração Pet - Meus dados</title>
      <meta property="og:title" content="Geração Pet - Meus dados" />
      <link rel="icon" href="/favicon.ico" />
      <meta
        name="description"
        content="Geração Pet - Meus dados"
      />
      <meta
    ...
    <Customer content={content} page="customerData"/>
  </React.Fragment>
);
